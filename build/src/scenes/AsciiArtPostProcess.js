...
var MyAsciiArtPostProcess = /** @class */ (function (_super) {
    ...
    function MyAsciiArtPostProcess() {
        ...
        _this._camera1 = postProcess;
        _this.PostProcessRenderPipelineManagerSceneComponent = new asciiArt_1.AsciiArtPostProcess("AsciiArt", camera1, ");, public, onStart(), void {}, public, onUpdate(), void {});
        return _this;
    }
    __decorate([
        (0, decorators_1.visibleInInspector)("camera1")
    ], MyAsciiArtPostProcess.prototype, "this", void 0);
